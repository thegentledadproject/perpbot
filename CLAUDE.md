...
- If deeper technical detail is genuinely needed for the task (e.g. writing actual code), still do that — but the explanation of what/why stays simple in ELI5.